...
author: "MA206 Tidyverse Tutorial code adapted by Conner Surrency and Gina Reynolds"
output: 
...
View code-movie [in a new tab](embedded_flipbooks/ex1.1_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/summarize_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex2.1_embed.html){target="_blank"} or below:
...
```{r ex2.2, echo = F, fig.height=3.5, eval = T}
employed_under_150K %>%
  ggplot() + 
  aes(x = Age) +
  aes(y = Earnings) +
...
View code-movie [in a new tab](embedded_flipbooks/ex2.2_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex2.3_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex3_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex3.1_embed.html){target="_blank"} or below:

```{r, echo = FALSE}
embed_flipbook(chunk_name = "ex3.1", 
               break_type = "rotate",
                       use_share_again = T,
                       font_size = 90,
                       title_page = T,
...
View code-movie [in a new tab](embedded_flipbooks/ex4.1_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex4,2_embed.html){target="_blank"} or below:
...
View code-movie [in a new tab](embedded_flipbooks/ex4.3_embed.html){target="_blank"} or below:
